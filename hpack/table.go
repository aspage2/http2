...
func (dt *DynamicTable) SetMaxSize(ms int) {
	if ms > dt.maxSize {
		dt.maxSize = ms
		return
	}
...
func (dt *DynamicTable) ForEach(f func(TableEntry)) {
...
func (dt *DynamicTable) Evict() (string, string, bool) {
	if dt.numEntries == 0 {
		return "", "", false
	}
...
func (dt *DynamicTable) Insert(key, value string) bool {
...
func (dt *DynamicTable) Nth(ind int) int {
...
func (dt *DynamicTable) NextOpen() int {
	return dt.Nth(dt.numEntries)
}

func (dt *DynamicTable) Lookup(ind int) (string, string, bool) {
	ind -= 1
...
func (dt *DynamicTable) String() string {
